...
use crate::{
    ...
    tunnel::obfuscation::get_global_obfuscation,
    proto::{
...
// 使用混淆配置中的魔数和版本，而不是硬编码值
// 原始值: MAGIC = 0xd1e1a5e1, VERSION = 1
fn get_magic() -> u32 {
    get_global_obfuscation().handshake_magic
}

fn get_version() -> u32 {
    get_global_obfuscation().protocol_version
}
