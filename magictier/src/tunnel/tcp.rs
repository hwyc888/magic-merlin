...
mod tests {
    ...
    async fn tcp_bench_with_bind() {
        let listener = TcpTunnelListener::new("tcp://127.0.0.1:52713".parse().unwrap());
        let mut connector = TcpTunnelConnector::new("tcp://127.0.0.1:52713".parse().unwrap());
    ...
    async fn tcp_bench_with_bind_fail() {
        let listener = TcpTunnelListener::new("tcp://127.0.0.1:52714".parse().unwrap());
        let mut connector = TcpTunnelConnector::new("tcp://127.0.0.1:52714".parse().unwrap());
    ...
    async fn ipv6_domain_pingpong() {
        let listener = TcpTunnelListener::new("tcp://[::1]:31015".parse().unwrap());
        let mut connector =
            TcpTunnelConnector::new("tcp://test.magictier.top:31015".parse().unwrap());
