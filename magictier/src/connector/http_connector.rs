...
impl HttpTunnelConnector {
    ...
    async fn handle_302_redirect(
        ...
        // 1: http(s)://magictier.cn/?url=tcp://10.147.22.22:52710 (scheme is http, domain is ignored, path is splitted into proto type and addr)
        // 2: http(s)://tcp://10.137.22.22:52710 (connector url is appended to the scheme)
        // 3: tcp://10.137.22.22:52710 (scheme is protocol type, the url is used to construct a connector directly)
