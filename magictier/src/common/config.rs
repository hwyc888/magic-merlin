...
pub mod tests {
    ...
    fn test_stun_servers_config() {
        ...
        let custom_servers = vec!["txt:stun.magictier.cn".to_string()];
...
stun_servers = [
    ...
    "txt:stun.magictier.cn"
        ...
        assert_eq!(stun_servers[2], "txt:stun.magictier.cn");
    }
...
ipv4 = "10.144.144.10"
listeners = [ "tcp://0.0.0.0:52710", "udp://0.0.0.0:52710" ]
...
[[peer]]
uri = "tcp://public.magictier.top:52710"

[[peer]]
uri = "udp://192.168.94.33:52710"
...
[[port_forward]]
bind_addr = "0.0.0.0:52714"
dst_addr = "192.168.94.33:52714"
proto = "tcp"
"#;
        ...
        assert_eq!(
            vec!["tcp://0.0.0.0:52710", "udp://0.0.0.0:52710"],
        ...
        assert_eq!(
            vec![PortForwardConfig {
                bind_addr: "0.0.0.0:52714".parse().unwrap(),
                dst_addr: "192.168.94.33:52714".parse().unwrap(),
                proto: "tcp".to_string(),
            }],
...
"#;
    ...
    /// `magictier/src/rpc_service/instance_manage.rs` 中实现
    #[tokio::test]
...
"#;
    ...
    async fn test_real_config_fields_expansion() {
        ...
        std::env::set_var("PEER_PORT", "52711");
        std::env::set_var("LISTEN_PORT", "52710");
...
"#;
        ...
        assert_eq!(listeners[0].to_string(), "tcp://0.0.0.0:52710");

        // 验证 peer 字段
        let peers = config.get_peers();
        assert_eq!(peers.len(), 1);
        assert_eq!(peers[0].uri.to_string(), "tcp://peer.example.com:52711");
...
listeners = ["tcp://0.0.0.0:${UNDEFINED_PORT:-52710}"]
