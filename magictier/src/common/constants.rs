...
define_global_var!(VERBOSE_OUTPUT, bool, false);

pub const UDP_HOLE_PUNCH_CONNECTOR_SERVICE_ID: u32 = 2;

pub const WIN_SERVICE_WORK_DIR_REG_KEY: &str = "SOFTWARE\\MagicTier\\Service\\WorkDir";

pub const MAGICTIER_VERSION: &str = git_version::git_version!(
